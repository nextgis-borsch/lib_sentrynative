...
function(get_cpack_filename ver name)
    ...
    if(DEFINED SENTRY_CPACK_PACKAGE_PREFIX)
        set(_cpack_prefix "${SENTRY_CPACK_PACKAGE_PREFIX}")
    else()
        set(_cpack_prefix "${PROJECT_NAME}")
    endif()
    set(${name} ${_cpack_prefix}-${ver}-${STATIC_PREFIX}${COMPILER} PARENT_SCOPE)
endfunction()
